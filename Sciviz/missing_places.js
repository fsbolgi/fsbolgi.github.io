var missing_places = ["Mosso Santa Maria", "Pistolesa", "Colcavagno", "Montiglio", "Scandeluzza"," Consiglio di Rumo"," Germasino"," Gravedona",
    ...
    "Monza","Muggiò","Nova Milanese","Ornago","Renate","Roncello","Ronco Briantino","Seregno","Seveso","Sovico","Sulbiate","Triuggio",
    "Usmate Velate","Varedo", "Vedano al Lambro","Veduggio con Colzano","Verano Brianza", "Villasanta","Vimercate", "Altidona", "Amandola",
    ...
    "La Maddalena", "Loiri Porto San Paolo", "Luogosanto", "Luras", "Monti", "Olbia", "Oschiri", "Palau", "Santa Teresa Gallura",
    ...
    "Carbonia", "Carloforte", "Collinas", "Domusnovas", "Fluminimaggiore", "Furtei", "Genuri", "Giba", "Gonnesa", "Gonnosfanadiga", "Guspini",
    "Iglesias", "Las Plassas", "Lunamatrona", "Masainas", "Musei", "Narcao", "Nuxis", "Pabillonis", "Pauli Arbarei", "Perdaxius", "Portoscuso",
    "Samassi", "San Gavino Monreale", "San Giovanni Suergiu", "Sanluri", "Santadi", "Sant'Anna Arresi", "Sant'Antioco", "Sardara", "Segariu",
    "Serramanna", "Serrenti", "Setzu", "Siddi", "Tratalias", "Tuili", "Turri", "Ussaramanna", "Villacidro", "Villamar", "Villamassargia",
    "Villanovaforru", "Villanovafranca", "Villaperuccio"];

var map_array = new Array(257);
for (i = 0; i< 257; i++){
